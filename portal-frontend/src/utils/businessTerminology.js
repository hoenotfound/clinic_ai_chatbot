  ...
  home_renovation: {
    ...
    qualificationView: {
      ...
      fields: [
        ...
        { key: "nextStep", label: "Requested next step", source: "activity", path: "nextStep", format: "nextStep" },
        { key: "siteVisitTiming", label: "Preferred site-visit timing", source: "activity", path: "appointmentPreference" },

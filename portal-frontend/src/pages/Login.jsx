...
export default function Inbox() {
  ...
  // Supports deep-linking from Contacts > "View conversation" (see
  // pages/Contacts.jsx), which navigates to /inbox?contact=<id>. Read once
  // on mount — the lazy initializer below runs before the "auto-select the
  // first conversation" effect further down, so a deep link always wins
  // over that default.
